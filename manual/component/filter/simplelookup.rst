...
Typischerweise wird diese Filterregel eingesetzt, um einen :ref:`Datensatz als Detailseite anzuzeigen
...
.. list-table::
   ...
   * - Attribut für Labeltext
     - Optionales zweites Attribut, dessen Wert als Anzeigetext im Frontend-Widget
       verwendet wird (z. B. ein Titelattribut statt des internen Alias) – ab MM 2.4.12.
