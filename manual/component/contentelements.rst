...
* **Sortierung**: |br|
  ...
  kann über die Filterregel "Eig. SQL" erfolgen (:ref:`siehe Kochbuch <_rst_cookbook_filter_custom-sql_sortierung-der-ausgabe-nach-mehr-als-einem-attribut-fest>`)
