.. _rst_cookbook_other_tutorials:

Andere Webseiten mit Tutorials, Tipps und Videos
================================================
...
+==================+========+===================================================================+=========+===========+==============+
| ContaoWiKi       | frei   | `Link <http://de.contaowiki.org/MetaModels>`_                     | DE      | 01/2017   | 26.01.2017   |
+------------------+--------+-------------------------------------------------------------------+---------+-----------+--------------+
| e-spin           | frei   | `Link <http://www.e-spin.de/contao-metamodels.html>`_             | DE      | 05/2024   | 02.03.2025   |
+------------------+--------+-------------------------------------------------------------------+---------+-----------+--------------+
| e-spin CK23 Repo | frei   | `Link <https://github.com/e-spin/vortrag-contao-konferenz-2023>`_ | DE      | 05/2024   |  02.03.2025  |
+------------------+--------+-------------------------------------------------------------------+---------+-----------+--------------+
